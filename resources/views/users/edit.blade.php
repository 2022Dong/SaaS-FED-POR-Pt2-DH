<x-app-layout>
    <article class="container mx-auto max-w-7xl">
        ...
        <section class="p-4 ">
            <form action="{{ route('users.update', $user) }}" method="POST" class="max-w-3xl flex flex-col gap-4">
                ...
                <fieldset class="grid grid-cols-7">
                    <label class="text-gray-500 col-span-2" for="Name">Name:</label>
                    <input type="text" id="Name" name="name" value="{{ old('name') ?? $user->name }}" placeholder="Enter user name" class="border-gray-200 col-span-5">
                    @error("name")
                ...
                <fieldset class="grid grid-cols-7">
                    <label class="text-gray-500 col-span-2" for="Email">Email:</label>
                    <input type="text" id="Email" name="email" value="{{ old('email') ?? $user->email }}" placeholder="Enter email address" class="border-gray-200 col-span-5">
                    @error("email")
                    <span class="text-gray-500 col-span-2"></span>
                    <p class="small text-red-500 col-span-5 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <fieldset class="grid grid-cols-7">
                    <label class="text-gray-500 col-span-2" for="Password">Password:</label>
                    <input type="text" id="Password" name="password" placeholder="Enter password" class="border-gray-200 col-span-5">
                    @error("password")
                    <span class="text-gray-500 col-span-2"></span>
                    <p class="small text-red-500 col-span-5 text-sm">{{ $message }}</p>
                    @enderror
                ...
                <fieldset class="grid grid-cols-7">
                    <label class="text-gray-500 col-span-2" for="Confirm">Confirm Password:</label>
                    <input type="password" id="Confirm" name="password_confirmation" placeholder="Confirm password" class="border-gray-200 col-span-5">
                </fieldset>

                <fieldset class="grid grid-cols-7">
                    <label class="text-gray-500 col-span-2" for="">Actions</label>
                    <p class="col-span-5 flex gap-4">
                        ...
                        <a href="{{ route('users.show', $user) }}" class="p-2 px-8 text-center rounded-md
